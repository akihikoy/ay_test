/*
src: https://github.com/np-csu/SLIC-superpixel-with-OpenCV

g++ -g -Wall -O2 -o slic_demo.out demo.cpp slic.cpp -lopencv_core -lopencv_imgproc -lopencv_highgui
...
int main(int argc, char** argv)
{
	...
	// img = cv::imread("..\\sample_image\\bird.jpg");
