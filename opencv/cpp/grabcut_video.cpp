...
g++ -I -Wall grabcut_video.cpp -o grabcut_video.out -lopencv_core -lopencv_ml -lopencv_video -lopencv_imgproc -lopencv_highgui -lopencv_videoio -I/usr/include/opencv4
