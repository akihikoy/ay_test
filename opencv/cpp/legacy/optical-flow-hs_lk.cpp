...
// g++ -I -Wall optical-flow-hs_lk.cpp -I/usr/include/opencv2 -lopencv_core -lopencv_ml -lopencv_video -lopencv_legacy -lopencv_imgproc -lopencv_highgui -lopencv_videoio
