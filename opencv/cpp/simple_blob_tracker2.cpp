...
g++ -g -Wall -O2 -o simple_blob_tracker2.out simple_blob_tracker2.cpp -lopencv_core -lopencv_imgproc -lopencv_features2d -lopencv_highgui

Run:
  $ ./simple_blob_tracker2.out
  OR
  $ ./simple_blob_tracker2.out CAMERA_NUMBER
