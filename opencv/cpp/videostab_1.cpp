// src: http://nghiaho.com/?p=2093
// src: http://nghiaho.com/uploads/code/videostab.cpp
...
int main(int argc, char **argv)
{
  ...
  std::cerr<<"camera opened"<<std::endl;
    ...
    ofstream out_transform("/tmp/prev_to_cur_transformation.txt");
    ofstream out_trajectory("/tmp/trajectory.txt");
    ofstream out_smoothed_trajectory("/tmp/smoothed_trajectory.txt");
    ofstream out_new_transform("/tmp/new_prev_to_cur_transformation.txt");
