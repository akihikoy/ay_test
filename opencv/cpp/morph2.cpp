...
g++ -g -Wall -O2 -o morph2.out morph2.cpp -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_videoio -I/usr/include/opencv4
...
int main(int argc, char**argv)
{
  ...
  for(;;)
  {
    ...
    p[0].push_back(t[1]);
    p[0].push_back(t[2]);
    cv::polylines(morphed, p1, /*isClosed=*/true, cv::Scalar(255,0,255), 2);
    cv::polylines(morphed, p2, /*isClosed=*/true, cv::Scalar(255,0,255), 2);
    cv::polylines(morphed, p, /*isClosed=*/true, cv::Scalar(255,0,255), 2);
