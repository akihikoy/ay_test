//-------------------------------------------------------------------------------------------
/*! \file    test1_2.cpp
    \brief   Ray tracing test 1-2 using Don Cross's library (doncross).
    \author  Akihiko Yamaguchi, akihiko-y@is.naist.jp / ay@akiyam.sakura.ne.jp
    \version 0.1
    \date    Feb.02, 2015

    Compile:
    g++ -g -Wall -O3 -o test1_2.out test1_2.cpp libdoncross.a
...
int main(int argc, char**argv)
{
  ...
  Cylinder* cylinder_in = new Cylinder(1.7, 4.7);
  cylinder_in->Move(0.3, 0.4, 0.0);
