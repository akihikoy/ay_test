...
OMPL for a continuous 3d-rigit body path planning assuming a UAV
  ...
  this constraint is satisfied by state validity checker
compile: x++ p3-02a-uav.cpp -- -I ~/prg/ompl/app/ompl/src -I ~/prg/ompl/app/src -L ~/prg/ompl/app/build/lib -lompl -Wl,-rpath ~/prg/ompl/app/build/lib -lboost_thread
exec: ./a.out
gnuplot -persistent res/result.gp
gnuplot -persistent res/result.gp > out-p3-02a-uav.svg
*/
