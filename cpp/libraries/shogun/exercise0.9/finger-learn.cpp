...
int main (int argc, char **argv)
{
  ...
  int tmp1,tmp2;
  LoadDataFromFile("out-pos.dat",feat,num,dim,-1,max_sample);
  LoadDataFromFile("out-params.dat",lab[0],tmp1,tmp2,0,max_sample);
  assert(tmp1==num);
  LoadDataFromFile("out-params.dat",lab[1],tmp1,tmp2,1,max_sample);
  assert(tmp1==num);
