...
int main (int argc, char **argv)
{
  ...
  if(LDIM==2)
  {
    LoadDataFromFile("out-2d-angle.dat",feat,num,dim,-1,max_sample);
    LoadDataFromFile("out-2d-pos.dat",lab[0],tmp1,tmp2,0,max_sample);
    assert(tmp1==num);
    LoadDataFromFile("out-2d-pos.dat",lab[1],tmp1,tmp2,1,max_sample);
    assert(tmp1==num);
  }
  else
  {
    LoadDataFromFile("out-3d-angle.dat",feat,num,dim,-1,max_sample);
    LoadDataFromFile("out-3d-pos.dat",lab[0],tmp1,tmp2,0,max_sample);
    assert(tmp1==num);
    LoadDataFromFile("out-3d-pos.dat",lab[1],tmp1,tmp2,1,max_sample);
    assert(tmp1==num);
    LoadDataFromFile("out-3d-pos.dat",lab[2],tmp1,tmp2,2,max_sample);
    assert(tmp1==num);
  }
