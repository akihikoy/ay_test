...
{
  static ofstream ofs_a("out-2d-angle.dat");
  static ofstream ofs_p("out-2d-pos.dat");
  static int count(0);
  ...
  ofs_a<<robot.GetAngleHinge(1)<<" "<<robot.GetAngleHinge(2)<<endl;
  ofs_p<<robot.GetHandPos()[0]<<" "<<robot.GetHandPos()[2]<<endl;
