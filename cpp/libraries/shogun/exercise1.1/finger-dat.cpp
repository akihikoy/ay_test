...
void set_params()
{
  double p0min(1.0),p0max(5.0);
  // double p1min(1.0),p1max(3.0);
  double p1min(2.0),p1max(2.0);
  Params[0]= (p0max-p0min)*dRandReal()+p0min;
  Params[1]= (p1max-p1min)*dRandReal()+p1min;
}
