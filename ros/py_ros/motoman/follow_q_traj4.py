...
if __name__=='__main__':
  ...
  add_point(goal, 0.0, angles, [0.0]*7)
  add_point(goal, 1.0, [q+0.02 for q in angles], [0.0]*7)
  add_point(goal, 3.0, [q-0.02 for q in angles], [0.0]*7)
  add_point(goal, 4.0, angles, [0.0]*7)
