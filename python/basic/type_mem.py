...
def UniqueID(prefix,N=6):
  for i in range(10000000):
    suffix= ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(N))
...
if __name__=='__main__':
  ...
  PrintD('NS1')
  PrintX('C2=Add(class_id="C2",data={"X":[i for i in range(5000000)]})')
  PrintD('NS1')
  Stat()
  ...
  PrintX('Add(class_id="C2",data={"X":[i for i in range(5000000)]})')
  PrintD('NS1')
  Stat()
