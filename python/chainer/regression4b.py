#!/usr/bin/python
#\file    regression4b.py
#\brief   Chainer for 3-D -> 2-D regression, a dynamics of ODE-GrPour simulation task.
#         Samples are obtained from simulation experiments.
#         This is similar to lwr/lwr_incr3a.py
...
def PlotGraphs():
  ...
  commands=[
    '''qplot -x2 aaa -3d {opt}
          ...
          /tmp/nn_test{NEpoch:04d}.dat w l lw 2 t '"Final({NEpoch}) epoch"'
          /tmp/smpl_train.dat pt 6 ps 2 t '"sample"'  &''',
          #/tmp/lwr/f3_est.dat w l lw 1 t '"LWR"'
