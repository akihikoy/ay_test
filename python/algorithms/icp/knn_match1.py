...
if __name__=='__main__':
  ...
  print 'Plot by:'
  print '$ qplot -x -s \'set size ratio -1\' /tmp/seq1.dat w l /tmp/knn1.dat w lp /tmp/seq2.dat w p'

  print 'KNNMatch1(seq2,seq1,k=1)'
  KNNMatch1(seq2,seq1,k=1,filename='/tmp/knn2.dat')
  print 'Plot by:'
  print '$ qplot -x -s \'set size ratio -1\' /tmp/seq1.dat w l /tmp/knn2.dat w lp /tmp/seq2.dat w p'
