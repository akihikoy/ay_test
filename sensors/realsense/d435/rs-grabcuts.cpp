// g++ -std=c++11 rs-grabcuts.cpp -lrealsense2 -lopencv_core -lopencv_imgproc -lopencv_highgui -o rs-grabcuts.out
...
int main(int argc, char * argv[]) try
{
    ...
    auto create_mask_from_depth = [&](Mat& depth, int thresh, int type)
    {
